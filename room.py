...
class room_booking_window:
    ...
    def total(self):
        if self.id_box.get()=="" or self.checkin_box.get()=="" or self.checkin_box.get()=="":
    ...
    def check_user(self):
        ...
        c.execute("SELECT * FROM rooms_table WHERE contact=?",(self.id_box.get(),))
        records=c.fetchall()
    ...
    def delete_record(self):
        if self.check_user():
            ...
            if response!=0:
                ...
                c.execute("DELETE FROM rooms_table WHERE contact=?",(self.id_box.get(),)) 
    ...
    def check_customer(self):
        ...
        c.execute("SELECT * FROM customers_table WHERE idnumber=?",(self.id_box.get(),))
        records=c.fetchall()
    ...
    def add_record(self):
        if self.id_box.get()=="" or self.checkin_box.get()=="":
            messagebox.showerror("Error","All fields are required",parent=self.root)
        else:
